...
export const CONTRACT_ADDRESSES = {
  ...
  causoraRegistry: (process.env.NEXT_PUBLIC_CAUSORA_REGISTRY_ADDRESS || '0x87F61f848EdD7C3e0752Ded3bf9C303E7c74BD81') as `0x${string}`,
  relationEngine: (process.env.NEXT_PUBLIC_RELATION_ENGINE_ADDRESS || '0x59a9771e60ED99cBC583fe4C3fd9e83e94AF606d') as `0x${string}`,
  causoraGuard: (process.env.NEXT_PUBLIC_CAUSORA_GUARD_ADDRESS || '0x4CABa84eF2D49dCFfDD5456AADEA5A42eB4a4699') as `0x${string}`,
  lendingPositionManager: (process.env.NEXT_PUBLIC_LENDING_MANAGER_ADDRESS || '0x94B336Cdb7aDacffE270a8f1B607499Be3656518') as `0x${string}`,
  causoraVault: (process.env.NEXT_PUBLIC_CAUSORA_VAULT_ADDRESS || '0x196a78ef8e039bD7E03C8d38694A0e5fB4EeBE92') as `0x${string}`,
  mockERC20: (process.env.NEXT_PUBLIC_MOCK_ERC20_ADDRESS || '0xC9F496A95f2Ab073976579CdeED113Bd1Ee71C11') as `0x${string}`,
} as const;
